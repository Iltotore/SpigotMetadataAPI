...
public class NBTTagList extends NBTBase<net.minecraft.server.v1_12_R1.NBTTagList> implements fr.il_totore.entitymetadata.api.nbt.NBTTagList {

    public NBTTagList(net.minecraft.server.v1_12_R1.NBTTagList handle) {
        super(handle);
    }
    ...
    public void addAll(Collection<fr.il_totore.entitymetadata.api.nbt.NBTBase> nbtBases) {
        if(nbtBases != null) nbtBases.forEach(this::add);
    }
    ...
    public NBTTagCompound getCompound(int i) {
        return new fr.il_totore.entitymetadata.api.v1_12_R1.nbt.NBTTagCompound(getHandle().get(i));
    }

    @Override
    public NBTNumber<Float> getFloat(int i) {
        return new NBTTagFloat(new net.minecraft.server.v1_12_R1.NBTTagFloat(getHandle().g(i)));
    }

    @Override
    public NBTNumber<Double> getDouble(int i) {
        return new NBTTagDouble(new net.minecraft.server.v1_12_R1.NBTTagDouble(getHandle().f(i)));
    }

    @Override
    public fr.il_totore.entitymetadata.api.nbt.NBTSingleValue<List<Integer>> getIntArray(int i) {
        return new NBTTagIntArray(new net.minecraft.server.v1_12_R1.NBTTagIntArray(getHandle().d(i)));
    }

    @Override
    public NBTSingleValue<String> getString(int i) {
        return new NBTTagString(new net.minecraft.server.v1_12_R1.NBTTagString(getHandle().getString(i)));
    }
    ...
    public NBTTagType<?> getValueType() {
        return NBTTagType.getById(getHandle().g());
    }
}
