...
import fr.il_totore.entitymetadata.api.v1_13_R2.datawatcher.DataWatcher;
import fr.il_totore.entitymetadata.api.v1_13_R2.nbt.*;
...
public class MetadataUtil implements fr.il_totore.entitymetadata.api.MetadataUtil {
    ...
    public fr.il_totore.entitymetadata.api.v1_13_R2.nbt.NBTTagCompound getNBTTag(Entity entity) {
        fr.il_totore.entitymetadata.api.v1_13_R2.nbt.NBTTagCompound nbt = new fr.il_totore.entitymetadata.api.v1_13_R2.nbt.NBTTagCompound(new net.minecraft.server.v1_13_R2.NBTTagCompound());
    ...
    public void setNBTTag(Entity entity, NBTTagCompound nbtTagCompound) {
        ((CraftEntity) entity).getHandle().f(((fr.il_totore.entitymetadata.api.v1_13_R2.nbt.NBTTagCompound) nbtTagCompound).getHandle());
    }
    ...
    public <V, T extends NBTBase> T nbtOf(NBTTagType<T> type, @Nullable V value) {
        switch(type.getId()) {
            ...
            case 9:
                return (T) new NBTTagList(new net.minecraft.server.v1_13_R2.NBTTagList());

            case 10:
                return (T) new fr.il_totore.entitymetadata.api.v1_13_R2.nbt.NBTTagCompound(new net.minecraft.server.v1_13_R2.NBTTagCompound());
