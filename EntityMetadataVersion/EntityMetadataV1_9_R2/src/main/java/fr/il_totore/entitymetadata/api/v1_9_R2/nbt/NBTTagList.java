...
public class NBTTagList extends NBTBase<net.minecraft.server.v1_9_R2.NBTTagList> implements fr.il_totore.entitymetadata.api.nbt.NBTTagList {

    public NBTTagList(net.minecraft.server.v1_9_R2.NBTTagList handle) {
        super(handle);
    }
    ...
    public NBTTagCompound getCompound(int i) {
        return new fr.il_totore.entitymetadata.api.v1_9_R2.nbt.NBTTagCompound(getHandle().get(i));
    }

    @Override
    public NBTNumber<Float> getFloat(int i) {
        return new NBTTagFloat(new net.minecraft.server.v1_9_R2.NBTTagFloat(getHandle().f(i)));
    }

    @Override
    public NBTNumber<Double> getDouble(int i) {
        return new NBTTagDouble(new net.minecraft.server.v1_9_R2.NBTTagDouble(getHandle().e(i)));
    }

    @Override
    public fr.il_totore.entitymetadata.api.nbt.NBTSingleValue<List<Integer>> getIntArray(int i) {
        return new NBTTagIntArray(new net.minecraft.server.v1_9_R2.NBTTagIntArray(getHandle().d(i)));
    }

    @Override
    public NBTSingleValue<String> getString(int i) {
        return new NBTTagString(new net.minecraft.server.v1_9_R2.NBTTagString(getHandle().getString(i)));
    }
