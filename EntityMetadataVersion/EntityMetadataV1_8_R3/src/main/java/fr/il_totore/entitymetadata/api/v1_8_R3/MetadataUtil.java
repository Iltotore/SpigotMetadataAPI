...
import fr.il_totore.entitymetadata.api.v1_8_R3.nbt.*;
...
import fr.il_totore.entitymetadata.api.v1_8_R3.datawatcher.DataWatcher;
...
public class MetadataUtil implements fr.il_totore.entitymetadata.api.MetadataUtil {
    ...
    public fr.il_totore.entitymetadata.api.v1_8_R3.nbt.NBTTagCompound getNBTTag(Entity entity){
        fr.il_totore.entitymetadata.api.v1_8_R3.nbt.NBTTagCompound nbt = new fr.il_totore.entitymetadata.api.v1_8_R3.nbt.NBTTagCompound(new net.minecraft.server.v1_8_R3.NBTTagCompound());
    ...
    public void setNBTTag(Entity entity, NBTTagCompound nbtTagCompound){
        ((CraftEntity) entity).getHandle().f(((fr.il_totore.entitymetadata.api.v1_8_R3.nbt.NBTTagCompound) nbtTagCompound).getHandle());
    }
