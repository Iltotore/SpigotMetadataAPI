...
public class NBTTagList extends NBTBase<net.minecraft.server.v1_13_R1.NBTTagList> implements fr.il_totore.entitymetadata.api.nbt.NBTTagList {
    ...
    public NBTTagCompound getCompound(int i) {
        return new fr.il_totore.entitymetadata.api.v1_13_R1.nbt.NBTTagCompound(getHandle().getCompound(i));
    }
