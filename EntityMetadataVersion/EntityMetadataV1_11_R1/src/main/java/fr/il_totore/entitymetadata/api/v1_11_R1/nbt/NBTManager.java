...
public class NBTManager implements fr.il_totore.entitymetadata.api.nbt.NBTManager {
    ...
    public fr.il_totore.entitymetadata.api.v1_11_R1.nbt.NBTTagCompound getNBTTag(Entity entity) {
        fr.il_totore.entitymetadata.api.v1_11_R1.nbt.NBTTagCompound nbt = new NBTTagCompound(new net.minecraft.server.v1_11_R1.NBTTagCompound());
    ...
    public <V, T extends NBTBase> T of(NBTTagType<T> type, @Nullable V value) {
        switch(type.getId()) {
            ...
            case 9:
                NBTTagList nbtList = new NBTTagList(new net.minecraft.server.v1_11_R1.NBTTagList());
                nbtList.addAll(value == null ? new ArrayList<>() : (Collection<NBTBase>) value);
                return (T) nbtList;

            case 10:
                return (T) new NBTTagCompound(new net.minecraft.server.v1_11_R1.NBTTagCompound());
    ...
    public NBTTagCompound fromString(String string) {
        ...
        } catch(net.minecraft.server.v1_11_R1.MojangsonParseException e) {
