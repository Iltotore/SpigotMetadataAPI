...
import fr.il_totore.entitymetadata.api.v1_9_R1.datawatcher.DataWatcher;
import fr.il_totore.entitymetadata.api.nbt.NBTTagCompound;
import fr.il_totore.entitymetadata.api.v1_9_R1.nbt.*;
...
public class MetadataUtil implements fr.il_totore.entitymetadata.api.MetadataUtil {
    ...
    public fr.il_totore.entitymetadata.api.v1_9_R1.nbt.NBTTagCompound getNBTTag(Entity entity){
        fr.il_totore.entitymetadata.api.v1_9_R1.nbt.NBTTagCompound nbt = new fr.il_totore.entitymetadata.api.v1_9_R1.nbt.NBTTagCompound(new net.minecraft.server.v1_9_R1.NBTTagCompound());
    ...
    public void setNBTTag(Entity entity, NBTTagCompound nbtTagCompound) {
        ((CraftEntity) entity).getHandle().f(((fr.il_totore.entitymetadata.api.v1_9_R1.nbt.NBTTagCompound) nbtTagCompound).getHandle());
    }
    ...
    public <V, T extends NBTBase> T nbtOf(NBTTagType<T> type, @Nullable V value) {
        switch(type.getId()) {
            ...
            case 10:
                return (T) new fr.il_totore.entitymetadata.api.v1_9_R1.nbt.NBTTagCompound(new net.minecraft.server.v1_9_R1.NBTTagCompound());
