...
public abstract class NBTNumber<T extends net.minecraft.server.v1_14_R1.NBTNumber, V extends Number> extends NBTSingleValue<T, V> implements fr.il_totore.entitymetadata.api.nbt.NBTNumber<V> {
