...
public class NBTTagCompound extends NBTBase<net.minecraft.server.v1_15_R1.NBTTagCompound> implements fr.il_totore.spigotmetadata.api.nbt.NBTTagCompound {

    public NBTTagCompound(net.minecraft.server.v1_15_R1.NBTTagCompound handle) {
        super(handle);
    }

    @Override
    public Set<String> keySet() {
        return getHandle().getKeys();
    }
    ...
    @Override
    public void setTag(String key, fr.il_totore.spigotmetadata.api.nbt.NBTBase nbtBase) {
    ...
    public NBTTagType getTypeOf(String key) {
        return NBTTagType.getById(getHandle().e(key));
    }
    ...
    @Override
    public NBTTagCompound merge(fr.il_totore.spigotmetadata.api.nbt.NBTTagCompound nbtTagCompound) {
