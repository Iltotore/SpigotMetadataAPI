...
public class NBTTagList extends NBTBase<net.minecraft.server.v1_16_R3.NBTTagList> implements fr.il_totore.spigotmetadata.api.nbt.NBTTagList {

    public NBTTagList(net.minecraft.server.v1_16_R3.NBTTagList handle) {
        super(handle);
    }
    ...
    public NBTNumber<Float> getFloat(int i) {
        return new NBTTagFloat(net.minecraft.server.v1_16_R3.NBTTagFloat.a(getHandle().i(i)));
    }

    @Override
    public NBTNumber<Double> getDouble(int i) {
        return new NBTTagDouble(net.minecraft.server.v1_16_R3.NBTTagDouble.a(getHandle().h(i)));
    }

    @Override
    public NBTSingleValue<List<Integer>> getIntArray(int i) {
        return new NBTTagIntArray(new net.minecraft.server.v1_16_R3.NBTTagIntArray(getHandle().f(i)));
    }

    @Override
    public NBTSingleValue<String> getString(int i) {
        return new NBTTagString(net.minecraft.server.v1_16_R3.NBTTagString.a(getHandle().getString(i)));
    }
