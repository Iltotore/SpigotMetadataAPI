...
public class NBTTagCompound extends NBTBase<net.minecraft.server.v1_16_R3.NBTTagCompound> implements fr.il_totore.spigotmetadata.api.nbt.NBTTagCompound {

    public NBTTagCompound(net.minecraft.server.v1_16_R3.NBTTagCompound handle) {
        super(handle);
    }
