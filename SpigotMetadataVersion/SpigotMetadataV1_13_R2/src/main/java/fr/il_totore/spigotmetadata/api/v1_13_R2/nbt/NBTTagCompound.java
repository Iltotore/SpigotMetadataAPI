...
public class NBTTagCompound extends NBTBase<net.minecraft.server.v1_13_R2.NBTTagCompound> implements fr.il_totore.spigotmetadata.api.nbt.NBTTagCompound {

    public NBTTagCompound(net.minecraft.server.v1_13_R2.NBTTagCompound handle) {
        super(handle);
    }
