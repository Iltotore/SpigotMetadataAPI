...
public abstract class NBTNumber<T extends net.minecraft.server.v1_13_R2.NBTNumber, V extends Number> extends NBTSingleValue<T, V> implements fr.il_totore.spigotmetadata.api.nbt.NBTNumber<V> {
