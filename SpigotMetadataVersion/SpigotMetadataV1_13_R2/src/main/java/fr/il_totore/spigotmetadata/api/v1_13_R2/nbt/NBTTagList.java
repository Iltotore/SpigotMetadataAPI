...
public class NBTTagList extends NBTBase<net.minecraft.server.v1_13_R2.NBTTagList> implements fr.il_totore.spigotmetadata.api.nbt.NBTTagList {
    ...
    public NBTNumber<Float> getFloat(int i) {
        return new NBTTagFloat(new net.minecraft.server.v1_13_R2.NBTTagFloat(getHandle().g(i)));
    }

    @Override
    public NBTNumber<Double> getDouble(int i) {
        return new NBTTagDouble(new net.minecraft.server.v1_13_R2.NBTTagDouble(getHandle().k(i)));
    }

    @Override
    public NBTSingleValue<List<Integer>> getIntArray(int i) {
        return new NBTTagIntArray(new net.minecraft.server.v1_13_R2.NBTTagIntArray(getHandle().i(i)));
    }

    @Override
    public NBTSingleValue<String> getString(int i) {
        return new NBTTagString(new net.minecraft.server.v1_13_R2.NBTTagString(getHandle().getString(i)));
    }
