...
public class NBTManager implements fr.il_totore.spigotmetadata.api.nbt.NBTManager {
    ...
    public NBTTagCompound getNBTTag(Entity entity) {
        NBTTagCompound nbt = new NBTTagCompound(new net.minecraft.server.v1_14_R1.NBTTagCompound());
    ...
    public <V, T extends fr.il_totore.spigotmetadata.api.nbt.NBTBase> T of(NBTTagType<T> type, @Nullable V value) {
        switch(type.getId()) {
            case 0:
                try {
            ...
            case 9:
                NBTTagList nbtList = new NBTTagList(new net.minecraft.server.v1_14_R1.NBTTagList());
                nbtList.addAll(value == null ? new ArrayList<>() : (Collection<fr.il_totore.spigotmetadata.api.nbt.NBTBase>) value);
                return (T) nbtList;

            case 10:
                return (T) new NBTTagCompound(new net.minecraft.server.v1_14_R1.NBTTagCompound());
