...
public class NBTTagCompound extends NBTBase<net.minecraft.server.v1_10_R1.NBTTagCompound> implements fr.il_totore.spigotmetadata.api.nbt.NBTTagCompound {

    public NBTTagCompound(net.minecraft.server.v1_10_R1.NBTTagCompound handle) {
        super(handle);
    }
