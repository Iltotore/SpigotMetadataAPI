...
import fr.il_totore.spigotmetadata.api.v1_10_R1.nbt.*;
import fr.il_totore.spigotmetadata.api.nbt.NBTTagType;
import fr.il_totore.spigotmetadata.api.v1_10_R1.datawatcher.DataWatcher;
...
public class MetadataUtil implements fr.il_totore.spigotmetadata.api.MetadataUtil {
    ...
    public fr.il_totore.spigotmetadata.api.nbt.NBTTagCompound getNBTTag(Entity entity) {
        NBTTagCompound nbt = new NBTTagCompound(new net.minecraft.server.v1_10_R1.NBTTagCompound());
