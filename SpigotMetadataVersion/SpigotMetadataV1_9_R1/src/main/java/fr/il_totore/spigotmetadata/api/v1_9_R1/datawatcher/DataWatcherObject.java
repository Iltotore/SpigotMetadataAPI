...
public class DataWatcherObject<F, T> implements fr.il_totore.spigotmetadata.api.datawatcher.DataWatcherObject<F, T> {
    ...
    private net.minecraft.server.v1_9_R1.DataWatcherObject<T> handle;
    private Function<F, T> bukkitToNotchFunction;
    private Function<T, F> notchToBukkitFunction;

    public DataWatcherObject(net.minecraft.server.v1_9_R1.DataWatcherObject<T> handle, Function<F, T> bukkitToNotchFunction, Function<T, F> notchToBukkitFunction){
        this.handle = handle;
    ...
    public net.minecraft.server.v1_9_R1.DataWatcherObject<T> getHandle(){
        return handle;
    }
