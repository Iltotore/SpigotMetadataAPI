...
import fr.il_totore.spigotmetadata.api.v1_11_R1.datawatcher.DataWatcher;
import fr.il_totore.spigotmetadata.api.v1_11_R1.nbt.*;
...
public class MetadataUtil implements fr.il_totore.spigotmetadata.api.MetadataUtil {
    ...
    public NBTTagCompound getNBTTag(Entity entity) {
        NBTTagCompound nbt = new NBTTagCompound(new net.minecraft.server.v1_11_R1.NBTTagCompound());
