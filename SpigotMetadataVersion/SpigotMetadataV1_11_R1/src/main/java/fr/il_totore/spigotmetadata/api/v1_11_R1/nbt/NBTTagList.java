...
import fr.il_totore.spigotmetadata.api.v1_11_R1.nbt.NBTTagCompound;

import java.util.ArrayList;
import java.util.Collection;
import java.util.List;

public class NBTTagList extends NBTBase<net.minecraft.server.v1_11_R1.NBTTagList> implements fr.il_totore.spigotmetadata.api.nbt.NBTTagList {
