...
public class DataWatcher implements fr.il_totore.spigotmetadata.api.datawatcher.DataWatcher {
    ...
    private net.minecraft.server.v1_16_R2.DataWatcher handle;

    public DataWatcher(net.minecraft.server.v1_16_R2.DataWatcher handle) {
        this.handle = handle;
    }
    ...
    public net.minecraft.server.v1_16_R2.DataWatcher getHandle() {
        return handle;
    }
}
