...
import fr.il_totore.spigotmetadata.api.v1_9_R2.datawatcher.DataWatcher;
import fr.il_totore.spigotmetadata.api.v1_9_R2.nbt.*;
...
public class MetadataUtil implements fr.il_totore.spigotmetadata.api.MetadataUtil {
    ...
    public NBTTagCompound getNBTTag(Entity entity) {
        NBTTagCompound nbt = new NBTTagCompound(new net.minecraft.server.v1_9_R2.NBTTagCompound());
