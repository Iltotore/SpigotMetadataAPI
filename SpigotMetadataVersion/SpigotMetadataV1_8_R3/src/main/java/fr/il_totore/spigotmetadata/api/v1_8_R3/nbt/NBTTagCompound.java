...
public class NBTTagCompound extends NBTBase<net.minecraft.server.v1_8_R3.NBTTagCompound> implements fr.il_totore.spigotmetadata.api.nbt.NBTTagCompound {

    public NBTTagCompound(net.minecraft.server.v1_8_R3.NBTTagCompound handle){
        super(handle);
    }
    ...
    public NBTTagType getTypeOf(String key){
        return NBTTagType.getById(getHandle().b(key));
    }
